...
$$
\frac{\partial l(\hat{\bm{c}}, \cdot)}{\partial \bm{\theta}} =
\frac{\partial l(\hat{\bm{c}}, \cdot)}{\partial \hat{\bm{c}}}
\frac{\partial \hat{\bm{c}}}{\partial \bm{\theta}}=
\frac{\partial l(\hat{\bm{c}}, \cdot)}{\partial \bm{w}^*(\hat{\bm{c}})}
\frac{\partial \bm{w}^*(\hat{\bm{c}})}{\partial \hat{\bm{c}}}
\frac{\partial \hat{\bm{c}}}{\partial \bm{\theta}}
$$
